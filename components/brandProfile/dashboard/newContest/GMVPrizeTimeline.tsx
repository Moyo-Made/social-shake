              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    className="mt-1"
                    value={incentives[0]?.name || ''}
                    onChange={(e) => handleIncentiveChange(0, 'name', e.target.value)}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    className="mt-1"
                    value={incentives[0]?.worth ? `${incentives[0].worth}` : ''}
                    onChange={(e) => handleIncentiveChange(0, 'worth', e.target.value)}
                  />
                </div>
              </div>
              <div className="mt-4">
                <Label htmlFor="incentive-desc-1" className="text-base mb-1">
                ...
                <Textarea
                  ...
                  className="mt-1"
                  value={incentives[0]?.description || ''}
                  onChange={(e) => handleIncentiveChange(0, 'description', e.target.value)}
                />
              </div>
            </CardContent>
          </Card>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Miami Trip for 2"
                    className="mt-1"
                    value={incentives[1]?.name || ''}
                    onChange={(e) => handleIncentiveChange(1, 'name', e.target.value)}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    placeholder="$5,000 GMV"
                    className="mt-1"
                    value={incentives[1]?.worth ? `${incentives[1].worth}` : ''}
                    onChange={(e) => handleIncentiveChange(1, 'worth', e.target.value)}
                  />
                </div>
              </div>
              <div className="mt-4">
                <Label htmlFor="incentive-desc-2" className="text-base mb-1">
                  List and Describe your Incentives
                </Label>
                <Textarea
                  id="incentive-desc-2"
                  ...
                  placeholder={`• Includes flight and 3-night stay in a luxury resort\n• Gift Cards\n• Apple Ipad`}
                  className="mt-1"
                  value={incentives[1]?.description || ''}
                  onChange={(e) => handleIncentiveChange(1, 'description', e.target.value)}
                />
              </div>
            </CardContent>
          </Card>
