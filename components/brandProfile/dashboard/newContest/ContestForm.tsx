...
const ContestFormContent = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      submitFormData.append("basic", JSON.stringify({
        ...formData.basic,
        thumbnail: null // Don't include the file in the JSON
      }));
      submitFormData.append("requirements", JSON.stringify(formData.requirements));
      submitFormData.append("prizeTimeline", JSON.stringify(formData.prizeTimeline));
      submitFormData.append("contestType", JSON.stringify(formData.contestType));
      ...
      submitFormData.append("createdAt", JSON.stringify(new Date().toISOString()));
      submitFormData.append("updatedAt", JSON.stringify(new Date().toISOString()));
