					...
					<TabsContent value="overview" className="w-full space-y-6 pl-4 pt-3">
						...
						<div className="space-y-4">
							...
							<div className="flex gap-28">
								...
								<p className="capitalize">{creatorPricing.industry || ""}</p>
							</div>

							<div className="flex gap-28">
								<h3 className="text-[#667085] font-normal w-40">Language:</h3>
								<p className="capitalize">{creatorPricing.language || ""}</p>
							</div>
							...
							<div className="mt-8">
								...
								<div className="flex gap-28 pt-4 border-b">
									...
									<p className="font-medium">
										${creatorPricing.cost.totalAmount || 0}
									</p>
								</div>
							</div>
						</div>
