...
export default function ContestDetailPage({ contestId }: ContestDetailPageProps) {
  ...
  if (loading) {
    return (
      <div className="flex-col container px-4 py-6 max-w-6xl bg-white border border-[#FFD9C3] rounded-lg mx-auto my-5 flex justify-center items-center h-64">
    ...
    <div className="container px-4 sm:px-5 py-6 max-w-6xl bg-white border border-[#FFD9C3] rounded-lg mx-auto my-5 relative">
      <div className="mb-6 relative">
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs w-fit ${
          ...
          <div className="md:hidden mb-4">
            ...
            >
              <span className="font-medium">
                {activeTab === "contest-overview" ? "Contest Overview" : 
                 activeTab === "applications" ? "Applications" :
                 activeTab === "available-metrics" ? "Available Metrics" : 
