			...
			<div className="flex justify-between mb-4">
				...
				<div className="flex gap-2">
					...
					<Button className="bg-orange-500 text-white px-4 py-1 rounded-md flex items-center">
						<Link href="/brand/dashboard/contests/new">Create New Contest</Link>
							...
							<div key={contest.id}>
								{contest.status === "Draft" ? (
									<div
										...
										onClick={(e) =>
											handleContestClick(contest, e as React.MouseEvent)
										}
									>
										<div className="rounded-lg p-4 bg-white border border-[#667085]">
											<ContestCard
												contest={contest}
									...
									<Link
										key={contest.id}
										href={`/brand/dashboard/contests/${contest.id}`}
									>
										<div
						...
						<span className="flex items-center">
							...
							{typeof contest.metrics.comments === "number"
								? contest.metrics.comments > 1000
									? `${(contest.metrics.comments / 1000).toFixed(1)}k`
