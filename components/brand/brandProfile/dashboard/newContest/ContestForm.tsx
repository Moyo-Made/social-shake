...
const ContestFormContent = () => {
	...
	useEffect(() => {
		...
		validateStep("basic", () => {
			const { contestName, industry, description, thumbnail } = formData.basic;
		...
		validateStep("prizeTimeline", () => {
			const { totalBudget, winnerCount, positions, startDate, endDate } =
	...
	const handleSubmit = async () => {
      ...
      sessionStorage.setItem("contestFormData", JSON.stringify(completeFormData));
      ...
      paymentFormData.append("contestName", formData.basic.contestName);
				...
				>
					<div className="flex items-center gap-2">
						...
						<AlertDescription className="text-green-700">
							...
							<a href="/brand/dashboard" className="underline font-medium">
								dashboard
							</a>
							.
						</AlertDescription>
