...
const VideoComponent = ({ videoId, currentPlayingVideo, setCurrentPlayingVideo, creator }: VideoComponentProps) => {
	...
	const handleVideoClick = (e: { preventDefault: () => void; stopPropagation: () => void; }) => {
	  e.preventDefault();
	  e.stopPropagation();
	  togglePlay();
	};
