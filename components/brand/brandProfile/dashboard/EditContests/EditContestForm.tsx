...
export default function EditContestForm({ contestId }: { contestId: string }) {
	...
	const { formData, saveDraft, isLoading } = useContestForm();
		...
		return (
			<div className="max-w-[44rem] mx-auto p-8">
				<Alert variant="destructive" className="mb-4">
					...
					<AlertDescription>
						{submissionError ||
							"You don't have permission to edit this contest"}
					</AlertDescription>
				</Alert>
				<Button
					onClick={() => router.push("/brand/dashboard/contests")}
	...
	return (
		<div className="max-w-[44rem] mx-auto">
			...
			{/* Step Content */}
			<div className="mb-6">{renderStepComponent()}</div>
