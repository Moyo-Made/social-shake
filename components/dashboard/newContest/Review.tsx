      ...
      <div className="">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="col-span-2">{basic.contestName || "Not specified"}</div>
          </div>
          
          <div className="grid grid-cols-3 gap-4">
            <div className="font-medium text-gray-600">Contest Description</div>
            <div className="col-span-2">{basic.description || "Not specified"}</div>
          </div>
          
          <div className="grid grid-cols-3 gap-4">
            <div className="font-medium text-gray-600">Contest Industry:</div>
            <div className="col-span-2">{basic.industry || "Not specified"}</div>
          </div>
                ...
                {previewUrl ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-full">
                    ...
                    <p className="text-gray-500 mt-2">
                      {basic.thumbnail ? basic.thumbnail.name : "No thumbnail selected"}
                    </p>
                  </div>
                )}
              </div>
      ...
      <div className="">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="col-span-2">
              {requirements.whoCanJoin === "allow-applications" ? "Allow Applications" : "Allow All Creators"}
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="col-span-2">
              {requirements.duration === "15-seconds" ? "15 Seconds" : 
               requirements.duration === "30-seconds" ? "30 Seconds" : "60 Seconds"}
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="col-span-2">
              {requirements.videoType === "client-script" ? "Client's Script" : "Creator's Script"}
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="col-span-2">
              {requirements.contentLinks.map((link, index) => (
                <div key={index} className={link ? "" : "text-gray-400"}>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="col-span-2">
              {requirements.brandAssets ? (
                <a href={requirements.brandAssets} className="text-orange-500 truncate block hover:underline">
                  {requirements.brandAssets}
                </a>
              ) : (
      ...
      <div className="">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="col-span-2">${prizeTimeline.totalBudget.toLocaleString()}</div>
          </div>
          
          <div className="grid grid-cols-3 gap-4">
            <div className="font-medium text-gray-600">Number of Winners</div>
            <div className="col-span-2">{prizeTimeline.winnerCount} Winners</div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="col-span-2">{formatDate(prizeTimeline.startDate)}</div>
          </div>
          
          <div className="grid grid-cols-3 gap-4">
            <div className="font-medium text-gray-600">Contest End Date</div>
            <div className="col-span-2">{formatDate(prizeTimeline.endDate)}</div>
          </div>
          
          <div className="grid grid-cols-3 gap-4">
            <div className="font-medium text-gray-600">Leaderboard Criteria</div>
            <div className="col-span-2">
              {prizeTimeline.criteria === "views" ? "Views" : 
               prizeTimeline.criteria === "likes" ? "Likes" : "Engagement Rate"}
            </div>
          </div>
        </div>
      </div>
