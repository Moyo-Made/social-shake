...
import { ContestFormProvider, useContestForm } from "@/components/dashboard/newContest/ContestFormContext";
import EditContestForm from "@/components/dashboard/EditContests/EditContestForm";
...
function ContestEditor({ contestId, userId }: { contestId: string; userId: string }) {
  ...
  useEffect(() => {
    const fetchContest = async () => {
      try {
        ...
        const response = await fetch(`/api/contests?contestId=${contestId}&userId=${userId}`);
