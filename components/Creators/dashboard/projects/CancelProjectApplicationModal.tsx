...
export default function CancelApplicationModal({
  ...
  const handleCancelApplication = async () => {
	...
	try {
	  ...
	  const response = await fetch("/api/projects/cancel-application", {
		method: "POST",
		headers: {
	  ...
	  <DialogContent className="sm:max-w-md bg-white px-6 py-5 rounded-lg font-satoshi">
		<DialogHeader>
		  ...
		  <DialogDescription className="text-sm text-gray-500 font-normal">
			  Are you sure you want to cancel your application for this project? This action cannot be undone.
		  </DialogDescription>
		</DialogHeader>
