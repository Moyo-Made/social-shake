...
export default function TikTokShopCreatorPricingTab() {
	...
	const totalVideos =
		selectionMethod === "invite"
			? // ? selectedCreators.length * videosPerCreator
	...
	const totalAmount = totalPayment + (musicTotal + rawFilesTotal);
			...
			<Card className="flex-1 max-w-72 border border-orange-500 rounded-xl">
				<CardContent className="pt-6">
					<div className="space-y-3">
						...
						<div>
							<h2 className="text-base font-medium mb-2">
								Affiliate Commision per Sale
							</h2>
							<div className="relative">
								<Input
									type="number"
									value={affiliateCommission}
									onChange={(e) => setAffiliateCommission(String(e.target.value))}
						...
						<div className="border-t pt-4 bg-[#FFF4EE] -mx-6 px-6 pb-6">
							...
							<div className="text-sm text-gray-500 mb-4">
								(Based on ${creatorPayment.toLocaleString()} per video ×{" "}
								{totalVideos} videos)
							</div>
