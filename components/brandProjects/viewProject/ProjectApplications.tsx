...
I'm thrilled about the opportunity to participate in your project! As a content creator with 10,000 Followers and an engagement rate of 60%, I've honed my skills in crafting TikTok videos that are not only visually appealing but also resonate with audiences and drive engagement.
...
I would love to be part of your project as I believe my content style would be a perfect match. I create lifestyle and fashion videos with a focus on authentic storytelling.
...
I'm excited to be part of this project! With my background in fashion content creation and my audience of 12,000 followers, I can create engaging content that will showcase your shoes in the best light possible.
...
I'd love to participate in your project as my content style aligns perfectly with your brand. I specialize in creating footwear and fashion content that showcases products in real-world situations.
			...
			<div className="flex flex-col md:flex-row gap-6 mx-auto p-4 text-start">
				...
				<div className="flex-1 bg-white rounded-lg border border-[#FFD9C3] p-6">
					...
					<h1 className="text-xl font-semibold mb-6 text-black">
						Project Application Submission - #{selectedApplication.id}
					</h1>
					...
					<div className="space-y-4">
						...
						<div>
							...
							<div className="mt-1 text-[#101828]">
				...
				<div className="w-full md:w-72">
					<div className="bg-white rounded-lg border border-[#FFD9C3] p-6 space-y-4">
						...
						<div>
							<p className="text-sm text-[#667085]">Average GMV Sales</p>
				...
				<div className="bg-white">
					{creators.length > 0 ? (
						...
						<div className="p-8 text-center text-gray-500">
							Applications were not enabled for this project.
						</div>
					)}
				</div>
			</div>
